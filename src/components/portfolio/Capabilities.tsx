...
export function Capabilities() {
  return (
    <Section id="capabilities" label="Capabilities" title="Capabilities and tools">
      <div className="grid border-l border-t border-rule md:grid-cols-2 lg:grid-cols-4">
      ...
      <Reveal className="mt-10">
        <div className="border-y border-rule py-6">
          <div>
            <p className="label-mono">Tools and methods</p>
